...
# Compile to PDF
# pdfmom -Tps report.mom > report.pdf || exit "$?" # This is the mom version
# groff -me -Tps report.me | ps2pdf - report.pdf || exit "$?" # This is the me version

# Newer mom version
# First, create PS
groff -Tps -mom report.mom > report.ps || exit "$?"
